...
button  bounds( 10,  5,70, 30), text("Wind","Wind"), latched(1), fontColour:0(100,100,100), channel("Wind"), 
...
rslider bounds(105,130, 80, 80), channel("ThunderDur"), text("Duration"), range(4, 25, 15)
rslider bounds(105,220, 80, 80), channel("ThunderDist"), text("Distance"), range(0, 1, 0.1)

button  bounds(210,  5,70, 30), text("Rain","Rain"), latched(1), fontColour:0(100,100,100), channel("Rain"), 
